...
The User Interface for Skyline Scroller is implemented purely via DOM overlays bound tightly to the underlying WebGL/Canvas game engine. The architecture consists of multiple layers of floating toolbars, modal windows, and an interactive terminal.
